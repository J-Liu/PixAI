...
final class L10n {
    ...
    private static let zh: [String: String] = [
        ...
        "AI Manual Watermark Removal": "AI 手动去水印",
        ...
        "Remove": "移除",
        "Clean": "清除",
        "Remove the selected region?": "清除选中区域的水印？",
        "AI upscaling…": "AI 超分中…",
        ...
        "AI dedup complete": "AI 去重完成",
        "No duplicates found": "未找到重复图片",
        "Manual watermark removal coming soon": "手动去水印功能即将推出",
        "Find and remove duplicate images from the current queue?": "在当前图片队列中查找并删除重复图片？",
        ...
        "Yes": "是",
        "No": "否",
        "Large duplicate group": "大型重复组",
        "Found %d similar images. Keep \"%@\" (best quality) and delete the rest?": "发现 %d 张相似图片。保留\"%@\"（质量最好）并删除其他？",
        "Delete others": "删除其他",
        "Skip this group": "跳过此组",
        "Keep all": "全部保留",
        "Delete “%@”?": "删除“%@”？",
        ...
        "Choose...": "选择...",
        // ── Crop mode ───────────────────────────────────────────────
        "Crop region selection:": "裁切区域选择：",
        "Full image": "全图",
        "Drag to select": "拖动选择",
        "Toolbar hidden opacity (0–1, 0 = invisible):": "工具栏隐藏透明度（0–1，0=完全隐藏）：",
        "Slideshow": "幻灯片",
        "Interval per slide (1–600 s):": "每张间隔（1–600 秒）：",
        "Slideshow interval (1–600 s):": "幻灯片间隔（1–600 秒）：",
        "When slideshow ends:": "幻灯片播放完后：",
        "Stop at last image": "停在最后一张",
        "Return to first image": "回到第一张",
        "Continuous loop": "循环播放",
        "Image Cache": "图片缓存",
        ...
        "Small image threshold (px, longest side):": "小图阈值（像素，最长边）：",
        // ── Watermark removal ───────────────────────────────────────
        "Mode:": "模式：",
        "Auto (detect watermark automatically)": "自动（自动检测水印）",
        "Manual (select region manually)": "手动（手动选择区域）",
        "Auto remove watermark on image load": "加载图片时自动去水印",
        "Detection sensitivity (0.1–0.9, lower = more sensitive):": "检测灵敏度（0.1–0.9，越小越敏感）：",
        "Min mask fraction (0.0001–0.1):": "最小遮罩比例（0.0001–0.1）：",
        "Min. watermark size (0.0001–0.1, lower = detect smaller):": "最小水印尺寸（0.0001–0.1，越小检测越小水印）：",
        "Mask edge feather (0–10 px, for smoother blending):": "遮罩边缘羽化（0–10 像素，更平滑融合）：",
        "Models not downloaded. Please download in AI Models tab.": "模型未下载，请在「AI 模型」页面下载。",
        "LaMa model required. Please download in AI Models tab.": "需要 LaMa 模型，请在「AI 模型」页面下载。",
        ...
        "Similarity threshold (0.70–0.99, higher = stricter):": "相似度阈值（0.70–0.99，越大越严格）：",
        ...
        "Proxy Recommended": "建议配置代理",
        "Super-Resolution model is hosted on HuggingFace. Download may be slow or fail in mainland China. Enable proxy?": "超分模型托管在 HuggingFace，中国大陆下载可能较慢或失败。是否启用代理？",
        "Enable Proxy": "启用代理",
        "Type:": "类型：",
        "Host:": "地址：",
        "Port:": "端口：",
    ...
    private static let zhHant: [String: String] = [
        ...
        "AI Manual Watermark Removal": "AI 手動去浮水印",
        ...
        "Remove": "移除",
        "Clean": "清除",
        "Remove the selected region?": "清除選中區域的浮水印？",
        "AI upscaling…": "AI 超分中…",
        ...
        "AI dedup complete": "AI 去重完成",
        "No duplicates found": "未找到重複圖片",
        "Manual watermark removal coming soon": "手動去浮水印功能即將推出",
        "Find and remove duplicate images from the current queue?": "在目前圖片佇列中尋找並刪除重複圖片？",
        ...
        "Yes": "是",
        "No": "否",
        "Large duplicate group": "大型重複組",
        "Found %d similar images. Keep \"%@\" (best quality) and delete the rest?": "發現 %d 張相似圖片。保留「%@」（質量最好）並刪除其他？",
        "Delete others": "刪除其他",
        "Skip this group": "跳過此組",
        "Keep all": "全部保留",
        ...
        "Choose...": "選擇...",
        // ── Crop mode ───────────────────────────────────────────────
        "Crop region selection:": "裁切區域選擇：",
        "Full image": "全圖",
        "Drag to select": "拖動選擇",
        "Toolbar hidden opacity (0–1, 0 = invisible):": "工具列隱藏透明度（0–1，0=完全隱藏）：",
        "Slideshow": "幻燈片",
        "Interval per slide (1–600 s):": "每張間隔（1–600 秒）：",
        "Slideshow interval (1–600 s):": "幻燈片間隔（1–600 秒）：",
        "When slideshow ends:": "幻燈片播放完後：",
        "Stop at last image": "停在最後一張",
        "Return to first image": "回到第一張",
        "Continuous loop": "循環播放",
        "Image Cache": "圖片快取",
        ...
        "Small image threshold (px, longest side):": "小圖閾值（像素，最長邊）：",
        // ── Watermark removal ───────────────────────────────────────
        "Mode:": "模式：",
        "Auto (detect watermark automatically)": "自動（自動偵測浮水印）",
        "Manual (select region manually)": "手動（手動選擇區域）",
        "Auto remove watermark on image load": "載入圖片時自動去浮水印",
        "Detection sensitivity (0.1–0.9, lower = more sensitive):": "偵測靈敏度（0.1–0.9，越小越靈敏）：",
        "Min mask fraction (0.0001–0.1):": "最小遮罩比例（0.0001–0.1）：",
        "Min. watermark size (0.0001–0.1, lower = detect smaller):": "最小浮水印尺寸（0.0001–0.1，越小偵測越小浮水印）：",
        "Mask edge feather (0–10 px, for smoother blending):": "遮罩邊緣羽化（0–10 像素，更平滑融合）：",
        "Models not downloaded. Please download in AI Models tab.": "模型未下載，請在「AI 模型」頁面下載。",
        "LaMa model required. Please download in AI Models tab.": "需要 LaMa 模型，請在「AI 模型」頁面下載。",
        ...
        "Similarity threshold (0.70–0.99, higher = stricter):": "相似度閾值（0.70–0.99，越大越嚴格）：",
        ...
        "Proxy Recommended": "建議設定代理",
        "Super-Resolution model is hosted on HuggingFace. Download may be slow or fail in mainland China. Enable proxy?": "超分模型託管在 HuggingFace，中國大陸下載可能較慢或失敗。是否啟用代理？",
        "Enable Proxy": "啟用代理",
        "Type:": "類型：",
        "Host:": "位址：",
        "Port:": "連接埠：",
